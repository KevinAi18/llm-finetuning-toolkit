...
1. Fork the [repository](https://github.com/KevinAi18/LLaMA-Factory) by clicking on the [Fork](https://github.com/KevinAi18/LLaMA-Factory/fork) button on the repository's page. This creates a copy of the code under your GitHub user account.
...
cd LLaMA-Factory
git remote add upstream https://github.com/KevinAi18/LLaMA-Factory.git
```
...
7. Create a merge request from your branch `dev_your_branch` at [origin repo](https://github.com/KevinAi18/LLaMA-Factory).
